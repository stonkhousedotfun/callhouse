 ...
 * lib/deployment.ts, lib/factoryLifecycle.ts (the factory market's week, status and settlement
 * decisions) — and the API's pure shapes in src/api/ (cycleJson and friends, serialize.ts),
