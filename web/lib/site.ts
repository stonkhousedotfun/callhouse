 ...
 *
 * stonkhouse.fun         — the marketing surface (repo stonkhousedotfun/callhouse-site). Static, no wallet code.
...
/**
 * Public product status. Same strings as stonkhousedotfun/callhouse-site `lib/site.ts`, so the two domains
 ...
 * (stonkhousedotfun/callhouse-site), not of this package. A copy here would be a second version to keep
