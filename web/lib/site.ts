 ...
 *
 * callhouse.xyz      — the marketing surface (the `site/` package). Static, no wallet code.
 ...
 * they render (entity, governing law, contact) are build-time constants of site/, not of this
 * package. A copy here would be a second version to keep in sync and would drift on the day
 * counsel fills the site's in. Both are absolute, cross-origin, and open in a new tab.
 */
